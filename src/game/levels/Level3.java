...
public class Level3 extends GameLevel implements ActionListener {
    ...
    private static final int NUM_FOOD = 7;

    private Timer timer;

    /**
     * Setting the appearance of Level 3.
     *
     * @param game will make level 3 appear on the Game
     */
    @Override
    ...
    /**
     * Checking level 3 is completed according to the number of food the food
     * the rat has eaten.
     *
