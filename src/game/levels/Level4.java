...
import game.walkers.GirlTeacher;
import game.walkers.ManTeacher;
...
public class Level4 extends GameLevel implements ActionListener {
    ...
    private Male male;
    private GirlTeacher girlTeacher;
    private ManTeacher manTeacher;
    private Donut donut;
    private Fries fries;
    ...
    private static final int NUM_FOOD = 8;

    private Timer timer;

    /**
     * Setting the appearance of Level 4.
     *
     * @param game will make level 4 appear on the Game
     */
    @Override
    public void populate(Game game) {
        ...
        girlTeacher = new GirlTeacher(this);
        girlTeacher.setPosition(new Vec2(b, a));
        girlTeacher.addCollisionListener(new Bump(getPlayer(), this));
        person.add(girlTeacher);

        manTeacher = new ManTeacher(this);
        manTeacher.setPosition(new Vec2(b, a));
        manTeacher.addCollisionListener(new Bump(getPlayer(), this));
        person.add(manTeacher);
    ...
    /**
     * Checking level 4 is completed according to the number of food the food
     * the rat has eaten.
     *
