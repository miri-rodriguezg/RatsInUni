...
public class Level1 extends GameLevel implements ActionListener {
    ...
    /**
     * Setting the appearance of Level 1.
     *
     * @param game will make level 1 appear on the Game
     */
    @Override
    ...
    /**
     * Checking level 1 is completed according to the number of food the food
     * the rat has eaten.
     *
