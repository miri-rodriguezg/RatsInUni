...
public class Level5 extends GameLevel implements ActionListener {
    ...
    private static final int NUM_FOOD = 9;

    private Timer timer;

    /**
     * Setting the appearance of Level 5.
     *
     * @param game will make level 5 appear on the Game
     */
    @Override
    ...
    /**
     * Checking level 5 is completed according to the number of food the food
     * the rat has eaten.
     *
